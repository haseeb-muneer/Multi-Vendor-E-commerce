 ...
 useEffect(() => {
  ...
  return (
    <>
      ...
      <div
        className={`${active === true ? "fixed top-0 left-0 shadow-sm z-10" : null} transition hidden 800px:flex items-center justify-between w-full bg-[#3321c8] h-[70px]`}
      >
        <div
        ...
        >
          ...
          <div onClick={() => setDropDown(!dropDown)}>
            <div className="relative h-[60px] mt-[10px] w-[270px] hidden 1000px:block">
              ...
              <button className="h-[100%] w-full flex items-center justify-between pl-10 bg-white font-sans font-[500] text-lg select-none rounded-t-md">
                All Categories
              </button>
              <IoIosArrowDown
                size={20}
